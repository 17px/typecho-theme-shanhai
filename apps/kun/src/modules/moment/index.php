            ...
            <div id="<?php $this->respondId(); ?>" class="py-4">
                ...
                <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                    ...
                    <div class="w-full mb-4 border border-zinc-200 rounded-lg bg-zinc-50 dark:bg-zinc-700 dark:border-zinc-600">
                        ...
                        <div>
                            <form method="post" action="<?php $this->commentUrl(); ?>" enctype="multipart/form-data">
                                <!-- 其他评论字段 -->
                                <p>
                                    <label for="comment-file">附件:</label>
                                    <input type="file" name="comment_file" id="comment-file">
