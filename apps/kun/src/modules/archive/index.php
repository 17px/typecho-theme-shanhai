...
<div class="mx-auto <?php $this->options->viewWidth() ?>">
    <h3 class="text-black text-opacity-80 mt-6 mb-2"><?php $this->archiveTitle([
    ...
    <p class="break-all mb-12 text-sm text-gray-500"><?php echo $this->getDescription(); ?></p>
